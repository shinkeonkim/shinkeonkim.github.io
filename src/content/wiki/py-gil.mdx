...
- [PEP 703: Making the GIL Optional](https://peps.python.org/pep-0703/) (Sam Gross, 2022)
- [PEP 779: Criteria for supported status for free-threaded Python](https://peps.python.org/pep-0779/) (Thomas Wouters 외, 2025)
- [PEP 734: Multiple Interpreters in the Stdlib](https://peps.python.org/pep-0734/) (Eric Snow, 2023)
- [PEP 684: A Per-Interpreter GIL](https://peps.python.org/pep-0684/) (Eric Snow, 2020)
- [py-free-threading tracking](https://py-free-threading.github.io/tracking/) (라이브러리 호환성 현황)
- [`concurrent.interpreters` 공식 문서](https://docs.python.org/3.14/library/concurrent.interpreters.html)
- [Free-threading Community Guide](https://py-free-threading.github.io/)
