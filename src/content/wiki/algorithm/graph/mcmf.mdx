...
aliases: ["mcmf", "min-cost max-flow", "최소 비용 최대 유량", "SSP", "successive shortest augmenting path"]
tags: [algorithm, graph, mcmf, min-cost-flow, ssp, spfa]
updated: 2026-06-25
references:
  - title: "solved.ac, mcmf"
    url: "https://solved.ac/problems/tags/mcmf"
    author: "solved.ac"
  - title: "Min-cost flow problem - Wikipedia"
...
- [[MFMC|최대 유량 최소 컷 정리]]
- [[Hungarian|헝가리안 알고리즘]]
- [solved.ac, mcmf](https://solved.ac/problems/tags/mcmf)
