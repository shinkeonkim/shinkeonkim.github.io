...
updated: 2026-06-25
references:
  - title: "solved.ac, line_intersection"
    url: "https://solved.ac/problems/tags/line_intersection"
    author: "solved.ac"
  - title: "CP-Algorithms, Check if two segments intersect"
    url: "https://cp-algorithms.com/geometry/check-two-segments-intersection.html"
...
- [[Sweeping]] (N 개 선분 교차)
- [solved.ac, line_intersection](https://solved.ac/problems/tags/line_intersection)
- [CP-Algorithms - Check if two segments intersect](https://cp-algorithms.com/geometry/check-two-segments-intersection.html)
