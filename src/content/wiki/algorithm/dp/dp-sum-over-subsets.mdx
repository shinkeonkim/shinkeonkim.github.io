...
aliases: ["SOS DP", "sum over subsets", "subset DP", "dp-sum-over-subsets", "zeta transform"]
tags: [algorithm, dp, sos-dp, bitmask]
updated: 2026-06-25
references:
  - title: "solved.ac, dp_sum_over_subsets"
    url: "https://solved.ac/problems/tags/dp_sum_over_subsets"
    author: "solved.ac"
  - title: "USACO Guide, SOS DP"
    url: "https://usaco.guide/adv/sos"
    author: "USACO Guide"
---
...
- [[DP|동적 계획법]]
- [solved.ac, dp_sum_over_subsets](https://solved.ac/problems/tags/dp_sum_over_subsets)
- [USACO Guide, SOS DP](https://usaco.guide/adv/sos)
