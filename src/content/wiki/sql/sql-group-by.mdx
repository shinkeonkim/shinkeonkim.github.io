...
references:
  - id: postgresql-docs
    note: "PostgreSQL Aggregate Functions - https://www.postgresql.org/docs/current/functions-aggregate.html"
  - id: mysql-docs
    note: "MySQL Aggregate Function Descriptions - https://dev.mysql.com/doc/refman/8.0/en/aggregate-functions.html"
  - id: postgresql-docs
    note: "PostgreSQL Window Functions - https://www.postgresql.org/docs/current/tutorial-window.html"
---
