...
- [[Non-Blocking]]
- [[ConcurrentHashMap]]
- Oracle, [LongAdder (Java Platform SE 21)](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/concurrent/atomic/LongAdder.html)
- Doug Lea et al., [JEP 155: Concurrency Updates](https://openjdk.org/jeps/155)
