...
- [[PriorityQueue]]
- [[Blocking]]
- Oracle, [PriorityBlockingQueue (Java Platform SE 21)](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/concurrent/PriorityBlockingQueue.html)
