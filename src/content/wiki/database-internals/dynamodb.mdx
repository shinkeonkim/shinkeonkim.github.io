...
- [[mongodb|MongoDB]] - 문서 DB 대안
- [[Redis]] - KV 대안
- [[aws-iam|IAM]] - DDB 권한
- [[sharding-vs-partitioning|샤딩 vs 파티셔닝]]
- [[aws-lambda|Lambda]] - Streams + Lambda CDC
- [[aws-s3|S3]] - 400KB 초과 데이터 저장
- [[aws-kinesis-data-streams|Kinesis Data Streams]] - Kinesis Data Streams for DynamoDB (CDC)
- [[aws-timestream|Timestream]] - 시계열 데이터 대안
- [[aws-glue|Glue]] - Zero-ETL to Redshift
- [[aws-redshift|Redshift]] - 분석 이관 대상
- [[aws-pinpoint|Pinpoint]] - Endpoints/Segments 대체 저장소
- [[data-lake|Data Lake]] - DDB Export to S3
- [[aws-organizations|Organizations]] - 계정 간 공유
