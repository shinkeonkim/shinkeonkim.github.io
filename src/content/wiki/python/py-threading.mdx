...
references:
  - id: python-docs
    note: "`threading` documentation - https://docs.python.org/3/library/threading.html"
  - id: python-docs
    note: "`queue` documentation - https://docs.python.org/3/library/queue.html"
  - id: python-docs
    note: "GIL discussion - https://docs.python.org/3/glossary.html#term-global-interpreter-lock"
  - id: python-peps
    note: "PEP 703 – Making the GIL Optional - https://peps.python.org/pep-0703/"
  - id: python-docs
    note: "`concurrent.futures` (고수준 래퍼) - https://docs.python.org/3/library/concurrent.futures.html"
---
