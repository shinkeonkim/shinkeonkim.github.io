...
references:
  - id: python-docs
    note: "`textwrap` documentation - https://docs.python.org/3/library/textwrap.html"
  - id: python-docs
    note: "`locale` documentation - https://docs.python.org/3/library/locale.html"
  - id: python-docs
    note: "`unicodedata` documentation - https://docs.python.org/3/library/unicodedata.html"
