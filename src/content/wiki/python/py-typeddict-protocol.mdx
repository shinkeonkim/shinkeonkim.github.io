...
references:
  ...
  - id: python-peps
    note: "PEP 589 – TypedDict - https://peps.python.org/pep-0589/"
  - id: python-peps
    note: "PEP 655 – Marking individual TypedDict items as required or not - https://peps.python.org/pep-0655/"
  - id: python-peps
    note: "PEP 692 – Using TypedDict for more precise **kwargs typing - https://peps.python.org/pep-0692/"
  - id: python-docs
    note: "`typing.Protocol` - https://docs.python.org/3/library/typing.html#typing.Protocol"
  - id: python-docs
