...
- [`asyncio` task context](https://docs.python.org/3/library/asyncio-task.html#asyncio.Task.get_context)
- [threading.local vs contextvars](https://docs.python.org/3/library/threading.html#thread-local-data)
