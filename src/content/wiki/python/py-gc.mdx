...
references:
  - id: python-docs
    note: "`gc` documentation - https://docs.python.org/3/library/gc.html"
  - id: python-docs
    note: "`weakref` documentation - https://docs.python.org/3/library/weakref.html"
  - title: "Garbage Collector Design – CPython Internals"
    url: "https://devguide.python.org/internals/garbage-collector/"
  - id: python-peps
    note: "PEP 442 – Safe object finalization - https://peps.python.org/pep-0442/"
  - title: "Instagram Engineering: Dismissing Python Garbage Collection"
    url: "https://engineering.fb.com/2017/01/30/production-engineering/dismissing-python-garbage-collection-at-instagram/"
---
