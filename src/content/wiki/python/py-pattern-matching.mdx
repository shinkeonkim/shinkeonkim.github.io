...
references:
  - id: python-peps
    note: "PEP 634 – Structural Pattern Matching: Specification - https://peps.python.org/pep-0634/"
  - id: python-peps
    note: "PEP 635 – Structural Pattern Matching: Motivation and Rationale - https://peps.python.org/pep-0635/"
  - id: python-peps
    note: "PEP 636 – Structural Pattern Matching: Tutorial - https://peps.python.org/pep-0636/"
  - id: python-docs
    note: "Python tutorial: match statements - https://docs.python.org/3/tutorial/controlflow.html#match-statements"
---
