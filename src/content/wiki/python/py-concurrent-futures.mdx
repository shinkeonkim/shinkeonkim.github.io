...
references:
  - id: python-docs
    note: "`concurrent.futures` documentation - https://docs.python.org/3/library/concurrent.futures.html"
  - id: python-peps
    note: "PEP 3148 – futures – execute computations asynchronously - https://peps.python.org/pep-3148/"
  - id: python-docs
    note: "`asyncio.to_thread` - https://docs.python.org/3/library/asyncio-task.html#asyncio.to_thread"
  - title: "`tqdm`"
