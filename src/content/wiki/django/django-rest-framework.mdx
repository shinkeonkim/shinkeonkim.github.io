...
references:
  ...
  - id: drf-docs
    note: "Requests - https://www.django-rest-framework.org/api-guide/requests/"
  - id: drf-docs
    note: "Documenting your API - https://www.django-rest-framework.org/topics/documenting-your-api/"
  - id: drf-docs
    note: "Tutorial Quickstart - https://www.django-rest-framework.org/tutorial/quickstart/"
...
DRF 는 파이프라인이 핵심. *한번 그림*으로 보면 이해가 쉽다:
