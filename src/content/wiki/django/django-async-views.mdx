...
- [Async views](https://docs.djangoproject.com/en/stable/topics/async/#async-views)
- [Async ORM (5.0+)](https://docs.djangoproject.com/en/stable/topics/db/queries/#async-queries)
- [Django Channels](https://channels.readthedocs.io/)
- [asgiref docs](https://asgi.readthedocs.io/)
