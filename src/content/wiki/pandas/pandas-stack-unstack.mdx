...
- [[Pandas melt]]
- [[Pandas MultiIndex]]
- 공식 문서, [stack](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.stack.html), [unstack](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.unstack.html)
