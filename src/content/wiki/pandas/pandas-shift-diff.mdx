...
- [[Pandas resample]]
- [[Pandas cumulative]]
- 공식 문서, [shift](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.shift.html), [diff](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.diff.html)
