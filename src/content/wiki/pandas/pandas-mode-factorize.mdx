...
aliases: ["Pandas mode", "Pandas factorize", "최빈값 pandas"]
...
- [[Pandas get_dummies]]
- 공식 문서, [mode](https://pandas.pydata.org/docs/reference/api/pandas.Series.mode.html), [factorize](https://pandas.pydata.org/docs/reference/api/pandas.factorize.html)
