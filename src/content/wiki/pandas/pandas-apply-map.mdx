...
aliases: ["Pandas Series apply", "Pandas Series map", "Series.apply", "DataFrame.apply elementwise"]
...
- 공식 문서, [apply](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.apply.html), [map](https://pandas.pydata.org/docs/reference/api/pandas.Series.map.html)
