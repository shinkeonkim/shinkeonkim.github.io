...
- [[Pandas .loc / .iloc]]
- 공식 문서, [query](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.query.html), [eval](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.eval.html)
