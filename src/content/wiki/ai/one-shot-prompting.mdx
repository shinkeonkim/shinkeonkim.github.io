...
> [!IMPORTANT]
> **Instruction-tuned 최신 모델 (GPT-5, Claude Opus 4, Gemini 2.5) 에서는 zero-shot 만으로 충분한 경우가 많아졌습니다.** 형식 강제가 목표라면 one-shot 대신 structured output (`response_format`, JSON schema) 을 쓰는 편이 안정적입니다.
