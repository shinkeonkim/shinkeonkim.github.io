...
- [[stt-streaming|STT 스트리밍]]
- [[tts-streaming-ssml|TTS 스트리밍 + SSML]]
- [[speech-to-speech-realtime|Speech-to-Speech Realtime]]
- [[vad-silero|VAD Silero]]
- [[turn-detection-barge-in|Turn Detection / Barge-in]]
- [[latency-percentiles|Latency 퍼센타일]]
- [[pipecat-livekit|Pipecat + LiveKit]]
- [[voice-rag|Voice RAG]] (음성 에이전트 + RAG 결합)
- [[voice-first-prompt|Voice-First 프롬프트 설계]]
