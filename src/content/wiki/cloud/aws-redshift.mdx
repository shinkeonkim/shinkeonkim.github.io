...
지원 format: CSV, TSV, JSON, [[apache-parquet|Parquet]], ORC, Avro. Parquet 가 컬럼형이라 로드 빠름. 대부분의 [[etl|ETL]] 파이프라인은 [[aws-glue|Glue]] 로 변환 후 Parquet 로 저장 -> COPY.
...
[[aws-glue|Glue Data Catalog]] 로 스키마 관리. [[apache-parquet|Parquet]] / ORC 가 성능 최적. 별도 요금 `$5/TB scanned`.

자세히: [[aws-redshift-spectrum|Redshift Spectrum]].
...
- [[data-warehouse|Data Warehouse]] - Redshift 가 구현하는 개념
- [[etl|ETL / ELT]] - 데이터 로딩 파이프라인
- [[apache-parquet|Apache Parquet]] - 권장 COPY 포맷
- [[aws-redshift-spectrum|Redshift Spectrum]] - S3 데이터 직접 쿼리
- [[aws-athena|Amazon Athena]] - Serverless SQL 대안
- [[aws-glue|AWS Glue]] - ETL + Data Catalog
- [[aws-rds|RDS]] - OLTP 대안
- [[aws-neptune|Neptune]] - 그래프 대안
- [[aws-documentdb|DocumentDB]] - NoSQL 대안
- [[aws-s3|S3]] - Spectrum, 백업 저장소
- [[aws-s3-glacier|S3 Glacier]] - Cold 데이터 아카이빙
