...
- [[aws-subnet-public-private|Public/Private Subnet]] - 서브넷 개념 상세
- [[aws-vpc-endpoints|VPC Endpoint]] - Interface / Gateway / Private NAT Gateway
- [[aws-privatelink|PrivateLink]] - VPC 간 사설 연결
- [[aws-region-az|Region / AZ]] - VPC 가 배치되는 물리 계층
- [[aws-sg|Security Group]] - ENI 레벨 방화벽
- [[aws-sg-vs-nacl|SG vs NACL]] - 두 방화벽 비교
- [[aws-alb-nlb|ALB / NLB]] - 로드밸런서
- [[aws-gwlb|Gateway Load Balancer]] - 보안 어플라이언스 우회
- [[aws-eni|ENI]] - VPC 안 네트워크 인터페이스
- [[network-cidr-subnetting|CIDR / Subnetting]] - 서브넷 계산
- [[network-ip|IPv4 / IPv6]] - IP 프로토콜
- [[aws-route53|Route 53]] - DNS (Route 53 Resolver for VPC)
- [[aws-eks|EKS]] - VPC CNI, pod IP 설계
- [[aws-direct-connect|Direct Connect]] - 전용 회선 연결
