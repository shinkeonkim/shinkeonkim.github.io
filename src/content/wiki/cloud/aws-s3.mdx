...
aliases: ["S3", "Simple Storage Service", "S3 storage class", "S3 lifecycle", "S3 Intelligent-Tiering", "S3 versioning"]
...
세 Glacier 클래스 (Instant / Flexible / Deep Archive) 의 상세는 [[aws-s3-glacier|S3 Glacier]] 참조.
...
- [[aws-s3-glacier|S3 Glacier]] - Cold/archive 스토리지 클래스
- [[aws-s3-files|S3 File Access]] - Mountpoint, File Gateway
- [[aws-s3-vectors|S3 Vectors]] - 벡터 저장 특화
- [[aws-athena|Amazon Athena]] - S3 데이터 SQL 쿼리
- [[aws-glue|AWS Glue]] - ETL + Data Catalog
- [[aws-redshift|Amazon Redshift]] - COPY 로 S3 데이터 로딩
- [[aws-redshift-spectrum|Redshift Spectrum]] - Redshift 에서 S3 직접 쿼리
- [[apache-parquet|Apache Parquet]] - 권장 파일 포맷
- [[data-warehouse|Data Warehouse]] - Data lake 저장소로서 S3
- [[etl|ETL / ELT]] - 데이터 파이프라인 저장소
- [[aws-cloudfront-cdn|CloudFront]] - 정적 자산 CDN
- [[aws-kms|KMS]] - 저장 암호화
- [[aws-lambda|Lambda]] - S3 이벤트 트리거
- [[aws-eventbridge|EventBridge]] - S3 이벤트 라우팅
- [[aws-iam|IAM]] - Bucket Policy
