...
```mermaid
flowchart LR
    SLI["SLI 측정<br/>#quot;5xx rate = 0.02%#quot;"]
    SLO["SLO 목표<br/>#quot;5xx < 0.1%#quot;"]
    SLA["SLA 계약<br/>#quot;가용성 99.9%, 미만 시 10% 환불#quot;"]
    EB["Error Budget<br/>#quot;30일 중 43분 다운 OK#quot;"]
    SLI --> Compare{비교}
    SLO --> Compare
    Compare --> EB
```
