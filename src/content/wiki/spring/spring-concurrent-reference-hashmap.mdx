...
- [[volatile]]
- [[ReentrantLock]]
- Spring Framework, [ConcurrentReferenceHashMap (Javadoc)](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/util/ConcurrentReferenceHashMap.html)
- Spring Framework 소스, [`ConcurrentReferenceHashMap.java`](https://github.com/spring-projects/spring-framework/blob/main/spring-core/src/main/java/org/springframework/util/ConcurrentReferenceHashMap.java)
- Oracle, [Reference Objects](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/ref/package-summary.html)
