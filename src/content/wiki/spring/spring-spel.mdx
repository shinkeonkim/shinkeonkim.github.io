...
references:
  - id: spring-docs
    note: "Spring Expression Language - https://docs.spring.io/spring-framework/reference/core/expressions.html"
  - id: spring-docs
    note: "Spring Security Expressions - https://docs.spring.io/spring-security/reference/servlet/authorization/expression-based.html"
  - id: spring-docs
    note: "Spring Cache SpEL - https://docs.spring.io/spring-framework/reference/integration/cache/annotations.html#cache-spel-context"
---
