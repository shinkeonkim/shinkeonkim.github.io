...
- [routes.rb DSL](https://api.rubyonrails.org/classes/ActionDispatch/Routing/Mapper/Resources.html)
- [Rails URL helpers](https://api.rubyonrails.org/classes/ActionDispatch/Routing/UrlFor.html)
- [Sidekiq Web UI mount](https://github.com/sidekiq/sidekiq/wiki/Monitoring)
