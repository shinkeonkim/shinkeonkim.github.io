...
> [!IMPORTANT]
> 2026 기준 신규 프로젝트는 **OAS 3.1** 권장. openapi-generator, Redoc, Swagger UI, Scalar 모두 3.1 지원. 기존 Swagger 2.0 스펙은 [swagger-converter](https://converter.swagger.io/) 로 자동 변환 가능.
...
- [[api-versioning|API 버전 관리]] (URL vs Header vs Media Type 전략)
- [[gRPC]] (proto 기반 대안)
- [[GraphQL]] (SDL 기반 대안)
- [[JWT]] (인증 스키마 표현)
- [[aws-api-gateway|AWS API Gateway]] (클라우드 게이트웨이에서 OpenAPI import 지원)
